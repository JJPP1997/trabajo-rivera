...
function getAllArticlesByTag(page){
		var tag="";
		switch(page){
			case 1:
				tag="cultura";
	   ...
	   $.ajax({
        ...
        dataType: 'json',
        data: {
            functionname: "getAllArticlesByTag",
			arguments:tag,
        },
        success: function (response) {
...
function insertAd(num){
	...
	$('#'+id).css('background-image', 'url("' +"/trabajo-rivera/Boletin/Imagenes/"+img+ '")');
